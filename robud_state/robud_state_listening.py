...
from robud.ai.stt.stt_common import TOPIC_STT_REQUEST
...
def robud_state_wakeword_detected(mqtt_client:mqtt.Client, client_userdata:Dict):
    try:
        ...
        #wait for text to finish, this should be changed to detect when audio is complete, but we'll just put a 2 second delay here.
        sleep(2)
        ...
        logger.info("Exiting ROBUD_STATE_WAKEWORD_DETECTION")
